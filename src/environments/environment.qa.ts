 ...
 * QA environment.
 *
 * Mirrors kiosk_straunt_storefront/src/environments/environment.qa.ts.
 * Used for QA / staging builds: npm run build:qa
 *
 * ── HOW TO SWITCH BRAND ───────────────────────────────────────────────────
 * Uncomment ONE brand block; keep the others commented out.
 * Then run:  npm run build:qa
 * ─────────────────────────────────────────────────────────────────────────
 */
...
export const environment: Environment = {
  ...
  location_id:          'tml_GRORFwWvvm8B3d',
